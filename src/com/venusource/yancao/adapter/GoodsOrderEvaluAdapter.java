...
public class GoodsOrderEvaluAdapter extends BaseAdapter {
	
	private List<Goods> list;
	private Context context;	
	
	public GoodsOrderEvaluAdapter(Context context,List<Goods> list) {		
	...
	public View getView(final int position, View convertView, ViewGroup parent) {		
		...
		if (view == null) {
			view = LayoutInflater.from(context).inflate(
					R.layout.order_goods_evalu_listview, null);
			viewholder = new ViewOrderCommitGoods();
			viewholder.goods_name = (TextView) view.findViewById(R.id.evalu_goods_commit_des);
			viewholder.goods_acount = (TextView) view.findViewById(R.id.evalu_goods_commit_num);
			viewholder.goods_price = (TextView) view.findViewById(R.id.evalu_goods_commit_price);
		...
		viewholder.goods_acount.setWidth(w*1);
